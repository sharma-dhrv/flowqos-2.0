...
{
      16,     0,    -1,    17,    23,    -1,    18,    -1,    17,    18,
      -1,    19,    20,    21,    22,    -1,     3,    -1,     4,    -1,
      10,    -1,     7,    -1,     6,    -1,     8,    -1,     9,    -1,
      12,    -1,    13,    -1,    11,    -1,     5,    22,    22,    -1,
      -1
};
...
{
       0,    38,    38,    41,    42,    45,    70,    71,    74,    77,
      78,    79,    80,    81,    82,    86,    90,   137
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_BIGENDIAN", "TOK_LITTLEENDIAN",
  "TOK_NEXT", "TOK_OUTPUT_INT", "TOK_OUTPUT_HEX", "TOK_OUTPUT_IPV4",
  "TOK_OUTPUT_FLAG", "TOK_CONSTANT", "TOK_IDENTIFIER", "TOK_OUTPUT_MAC",
  "TOK_OUTPUT_NONE", "'\"'", "$accept", "config", "elements", "element",
  "byteorder", "size", "output", "identifier", "nextfile", 0
};
#endif
...
{
       0,     6,     7,     0,    17,     3,     0,     1,     0,     4,
       2,     8,     0,    15,     0,    10,     9,    11,    12,    13,
      14,     0,    16,     5
};
...
{
       9,   -11,   -11,    14,     5,   -11,    -5,   -11,     4,   -11,
     -11,   -11,    -6,   -11,     4,   -11,   -11,   -11,   -11,   -11,
     -11,     4,   -11,   -11
};
...
{
       0,     3,     4,    16,    17,    18,    19,     0,     5,    18,
      23,    10,    20,    11,    22,     6,     7,     8,     9,    12,
      13,    21,    22,    22
};
