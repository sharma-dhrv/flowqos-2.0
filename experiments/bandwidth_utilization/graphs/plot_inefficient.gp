...
plot "inefficient.dat" using ($1):($2/1000.0):(2.0) title 'Video (RTP)' smooth acsplines lt 1 lc rgb "#00dd00" lw 4, \
     "inefficient.dat" using ($1):($3/1000.0):(2.0) title 'Background Traffic (Iperf TCP)' smooth acsplines lt 2 lc rgb "#dd0000" lw 4, \
     "inefficient.dat" using ($1):($4/1000.0):(2.0) title 'Total Bandwidth Consumption' smooth acsplines lt 5 lc rgb "#0000dd" lw 4
