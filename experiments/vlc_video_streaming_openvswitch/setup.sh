...
#OVS_IN_FLOWS="flows1.txt"
OVS_IN_FLOWS="ovs-in_flows.txt"
#OVS_OUT_FLOWS="flows2.txt"
OVS_OUT_FLOWS="ovs-out_flows.txt"
...
create()
{
    ...
    ovs-ofctl add-flows $OVS_IN $OVS_IN_FLOWS
    create_ovs $OVS_OUT $DPID_OUT
    ovs-ofctl add-flows $OVS_OUT $OVS_OUT_FLOWS
