...
plot 'data.dat' using 6:7:xtic(1) title 'DASH-JS (HTTP Video) Streaming only' lc rgb "#00dd00" lt 1 lw 3, \
     'data.dat' using 2:3:xtic(1) title 'DASH-JS (HTTP Video) Streaming + Background Traffic (Iperf TCP) with Flow Classification' lt 1 lw 3 lc rgb "#0000dd", \
     'data.dat' using 4:5:xtic(1) title 'DASH-JS (HTTP Video) Streaming + Background Traffic (Iperf TCP) without Flow Classification' lt 1 lw 3 lc rgb "#dd0000"
